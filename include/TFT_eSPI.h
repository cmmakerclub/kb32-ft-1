...
public:
  ...
  void drawRect(int32_t x, int32_t y, int32_t w, int32_t h, uint32_t color),
      ...
      drawXBitmap(int16_t x, int16_t y, const uint16_t *bitmap, int16_t w, int16_t h, uint16_t color),
      drawXBitmap(int16_t x, int16_t y, const uint16_t *bitmap, int16_t w, int16_t h, uint16_t fgcolor, uint16_t bgcolor),
