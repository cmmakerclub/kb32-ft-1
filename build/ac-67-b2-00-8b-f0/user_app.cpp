...
void loop() {
  ...
  tft.print("Hello");    // Print the font name onto the TFT screen
  tft.setCursor(20, 50);    // Set cursor near top left corner of screen
  tft.setTextColor(TFT_WHITE);
  tft.print("กขคงจฉชซ อฮ");
  tft.setCursor(60, 75);    // Set cursor near top left corner of screen
  tft.setTextColor(TFT_RED);
  tft.print(String("บนปากโอ่ง"));
  delay(3000);
